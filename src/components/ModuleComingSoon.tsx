export function ModuleComingSoon({ name }: { name: string }) {
  return (
    <div className="mx-auto max-w-lg rounded-2xl border border-[var(--gs-border)] bg-white p-10 text-center shadow-sm">
      <p className="text-xs font-bold uppercase tracking-wide text-[var(--gs-accent)]">{name}</p>
      <h2 className="mt-3 text-xl font-bold text-[var(--gs-navy)]">Coming soon</h2>
