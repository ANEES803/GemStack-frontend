    ...
    <div className="rounded-2xl border border-[var(--gs-border)] bg-white p-5 shadow-sm sm:p-6">
      ...
      <div className="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        ...
        <div className="sm:col-span-2 lg:col-span-2">
          <label className="block text-[10px] font-bold uppercase tracking-wide text-slate-500">Comparison period</label>
          <select
        ...
        <div>
          <label className="block text-[10px] font-bold uppercase tracking-wide text-slate-500">Accounting method</label>
          <select
        ...
        <div className="rounded-xl border border-slate-100 bg-slate-50/80 p-4 sm:col-span-2">
          <p className="text-[10px] font-bold uppercase tracking-wide text-slate-500">Show</p>
