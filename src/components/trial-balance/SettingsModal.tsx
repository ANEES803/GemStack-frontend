    ...
    <div className="fixed inset-0 z-[200] flex items-end justify-center bg-black/50 p-0 sm:items-center sm:p-4">
      ...
      >
        <div className="flex items-center justify-between border-b border-[var(--gs-border)] px-5 py-4">
          <h2 id="tb-settings-title" className="text-lg font-bold text-[var(--gs-text)]">
        ...
        <div className="max-h-[min(70dvh,560px)] space-y-4 overflow-y-auto px-5 py-5">
          <label className="flex cursor-pointer items-center justify-between gap-4 rounded-xl border border-[var(--gs-border)] bg-[var(--gs-hover)]/80 px-4 py-3">
            <span className="text-sm font-medium text-[var(--gs-text)]">Show account codes</span>
            <input
              type="checkbox"
          ...
          <label className="flex cursor-pointer items-center justify-between gap-4 rounded-xl border border-[var(--gs-border)] bg-[var(--gs-hover)]/80 px-4 py-3">
            <span className="text-sm font-medium text-[var(--gs-text)]">Show account type</span>
            <input
              type="checkbox"
          ...
          <div>
            <label className="block text-xs font-bold uppercase tracking-wide text-[var(--gs-muted)]">Default sorting</label>
            <select
