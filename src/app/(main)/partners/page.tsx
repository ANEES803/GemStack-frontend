    ...
    <div className="mx-auto max-w-7xl space-y-6">
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <div className="rounded-2xl border border-[var(--gs-border)] bg-[var(--gs-card)] p-5 shadow-sm lg:col-span-2">
          ...
          <div className="gs-table-scroll mt-4 overflow-x-auto overscroll-x-contain [-webkit-overflow-scrolling:touch]">
        ...
        <div className="rounded-2xl border border-emerald-200 bg-emerald-50/80 p-5 shadow-sm dark:border-emerald-800 dark:bg-emerald-950/35">
          <h3 className="font-bold text-emerald-950 dark:text-emerald-100">Profit distribution</h3>
          <p className="mt-2 text-sm text-emerald-900 dark:text-emerald-100/90">Demo net profit: {formatMoney(profitToDistribute, "PKR")}</p>
